...
var PrintHook = /** @class */ (function () {
    ...
    /** @nocollapse */ PrintHook.ngInjectableDef = ɵɵdefineInjectable({ factory: function PrintHook_Factory() { return new PrintHook(ɵɵinject(BreakPointRegistry), ɵɵinject(LAYOUT_CONFIG), ɵɵinject(PLATFORM_ID)); }, token: PrintHook, providedIn: "root" });
    return PrintHook;
}());
// ************************************************************************
