...
var PrintHook = /** @class */ (function () {
    function PrintHook(breakpoints, layoutConfig, _platformId) {
    ...
    function (target) {
        var _this = this;
        if (!common.isPlatformBrowser(this._platformId) || this.registeredBeforeAfterPrintHooks) {
            return;
        }
        this.registeredBeforeAfterPrintHooks = true;
        // Could we have teardown logic to remove if there are no print listeners being used?
        ((/** @type {?} */ (window))).addEventListener('beforeprint', (/**
         * @return {?}
         */
        function () {
        ...
        ((/** @type {?} */ (window))).addEventListener('afterprint', (/**
         * @return {?}
         */
        function () {
            // If we aren't already printing, start printing and update the styles as
    ...
    /** @nocollapse */ PrintHook.ngInjectableDef = core.ɵɵdefineInjectable({ factory: function PrintHook_Factory() { return new PrintHook(core.ɵɵinject(BreakPointRegistry), core.ɵɵinject(LAYOUT_CONFIG), core.ɵɵinject(core.PLATFORM_ID)); }, token: PrintHook, providedIn: "root" });
    return PrintHook;
}());
// ************************************************************************
